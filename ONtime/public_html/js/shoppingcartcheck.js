...
function validateForm(e){
    ...
    if(document.getElementById("cashradio").checked == true){
        ...
        var cardname = document.forms["billinginfo"]["cardname"].value;
        if (cardname == "") {
        ...
        var cardnumber = document.forms["billinginfo"]["cardnumber"].value;
        ...
        var cvv = document.forms["billinginfo"]["cvv"].value;
        if (cvv.length < 3) {
